  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imgerror="defaultImage" :src="staffPhoto">
            <!-- 头像图片动态绑定 -->
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p><!-- 数据通通换成动态的 -->
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCancel">
      <el-form ref="ruleForm" label-width="120px" :model="ruleForm" :rules="rules">
        ...
        <el-form-item label="离职时间" prop="reason">
          <el-input
...
<script>
import { mapGetters, createNamespacedHelpers } from 'vuex' // 引入基于某个命名空间的辅助函数
const { mapState } = createNamespacedHelpers('user') // 调用createNamespacedHelpers辅助函数，传入对应模块的名称，返回一个对象，对象内绑定了该模块内所有的辅助函数
